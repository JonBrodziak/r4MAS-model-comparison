...
- Case 12: Misreported catch
  - Multiply "true" age composition with randomly generated values that follow an uniform distribution with min of 0.8 and max of 1. Misreporting follows a uniform random distribution across years.
  
- Case 13: Misreported catch
  - Multiply "true" age composition with randomly generated values that follow an uniform distribution with min of 0.5 and max of 1. Misreporting follows a uniform random distribution across years.
  
- Case 14: Misreported catch
...
- Case 15: Misreported catch
  - Multiply "true" age composition with randomly generated values that follow an uniform distribution with min of 0.8 and max of 1. Misreporting follows a uniform random distribution across ages and years.
