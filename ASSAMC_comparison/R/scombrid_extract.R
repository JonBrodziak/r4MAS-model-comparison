...
tropical.scombrid$WL_units

condition <- which(tropical.scombrid$WL_units %in% c("W in kg and FL in cm", "W in kg and ? In mm", "W in kg and TL in mm"))
tropical.scombrid$WL_a[condition] <- tropical.scombrid$WL_a[condition]/(10^tropical.scombrid$WL_b[condition])

condition <- which(tropical.scombrid$WL_units %in% c("W in g and FL in cm", "W in ozs and FL in cm"))
tropical.scombrid$WL_a[condition] <- tropical.scombrid$WL_a[condition]/(1000*10^tropical.scombrid$WL_b[condition])

tropical.scombrid$WL_a[146] <- tropical.scombrid$WL_a[146]/(10^tropical.scombrid$WL_b[146])
median(tropical.scombrid$WL_a, na.rm = T)
