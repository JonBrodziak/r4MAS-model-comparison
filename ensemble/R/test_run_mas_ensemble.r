...
#' On the model m111-m235 in the ensemble model for case study 1
#' @name run_mas_ensemble
#' @description Function to read simulated true values from the operating model and to run MAS with different inputs
#' @param input_list A list of input data from the operating model
#' @param fishery_selectivity_input Input data for MAS fishery selectivity
#' @param recuritment_steepness_input Input data for MAS recruitment steepness
#' @param natural_mortality_input Input data for MAS natural mortality
#' @export

run_mas_ensemble <- function(
  input_list, 
  fishery_selectivity_input, 
  recruitment_steepness_input,
  natural_mortality_input
  ) {
  ...
  invisible(sapply(subdir, function(x) {
  ...
  for (om_sim in 1:om_sim_num) {
    ...
    recruitment$h$value <- recruitment_steepness_input
    recruitment$h$estimated <- FALSE
    recruitment$h$phase <- 3
    recruitment$h$min <- 0.20
    ...
    natural_mortality$SetValues(natural_mortality_input)
    ...
    if (fishery_selectivity_input$fleet1$pattern == 1) {
      fleet_selectivity <- new(r4mas$LogisticSelectivity)
      fleet_selectivity$a50$value <- fishery_selectivity_input$fleet1$A50.sel
      ...
      fleet_selectivity$slope$value <- 1 / fishery_selectivity_input$fleet1$slope.sel
    ...
    if (fishery_selectivity_input$fleet1$pattern == 2) {
      fleet_selectivity <- new(r4mas$DoubleLogisticSelectivity)
      
      fleet_selectivity$alpha_asc$value <- fishery_selectivity_input$fleet1$A50.sel1
      ...
      fleet_selectivity$beta_asc$value <- fishery_selectivity_input$fleet1$slope.sel1
      ...
      fleet_selectivity$alpha_desc$value <- fishery_selectivity_input$fleet1$A50.sel2
      ...
      fleet_selectivity$beta_desc$value <- fishery_selectivity_input$fleet1$slope.sel2
